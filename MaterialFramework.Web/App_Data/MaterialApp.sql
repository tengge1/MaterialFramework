...
Source Database       : MaterialFramework
Source Schema         : dbo
...
GO
GO
INSERT INTO [dbo].[AppConfig] ([ID], [Name], [ConfigKey], [ConfigValue], [Status], [SectionID], [Sort], [Comment]) VALUES (N'2', N'数据库名称', N'DatabaseName', N'MaterialFramework', N'1', N'1003', N'1', N'连接数据库的名称，数据库备份还原使用。')
GO
GO
